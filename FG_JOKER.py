...
print('\n\033[0;97m[+]\033[1;32m WELLCOME TO RANA TOOL 𝙅𝙊𝙆𝙀𝙍...')
...
{W} [{R}+{W}]{R} OWNER   {R}:{R} 𝙎𝙃𝘼𝙃𝙄 𝙅𝙊𝙆𝙀𝙍 𝙆𝙃𝘼𝙉𝙊𝙊
{W} [{R}+{W}]{W} FB ID   {R}:{W} 𝙈𝘿𝙅𝙊𝙆𝙀𝙍.5214
{W} [{R}+{W}]{W} WHATSAP {R}:{W} 0707266012
{W} [{R}+{W}]{R} STATUS  {R}:{R} {status}
{W} [{R}+{W}]{R} VERSION {R}:{R} {version}
{W} [{R}+{W}]{R}<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>++<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>{W}
{W} [{R}+{W}]{W}            \033[1;41m\033[1;37m[WELLCOME TO \033[1;42m\033[1;37m𝙅𝙊𝙆𝙀𝙍 TOOL]\x1b[0m
...
def Create_M2():
		...
		os.system('cd && cd FILE ;python FG_JOKER.py')
######RANDOM CLONE###
def Main_Menu():
    clear()
